...
export const MUSCLE_GROUP_DATA: MuscleGroup = {
    biceps: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-barbell-curl-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-Dumbbells-dumbbell-hammer-curl-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-biceps-stretch-variation-1-side.mp4#t=0.1",
    ...
    traps: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-dumbbell-seated-shrug-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-traps-stretch-variation-1-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-pike-pushup-side.mp4#t=0.1",
    ...
    deltoids: [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-dumbbell-seated-overhead-press-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-Cables-cable-lateral-raise-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-shoulders-stretch-variation-2-side.mp4#t=0.1",
    ...
    pectoral : [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-dips-front.mp4#t=0.1",
            exerciseName: "Dips",
            difficulty: "Intermediate",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-barbell-bench-press-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-incline-bench-press-side.mp4#t=0.1",
    ...
    forearms: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-dumbbell-wrist-curl-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-forearms-stretch-variation-2-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-barbell-behind-the-back-wrist-curl-side.mp4#t=0.1",
    ...
    abdominal: [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-long-lever-plank-side.mp4#t=0.1",
            exerciseName: "Long Lever Plank",
            difficulty: "Advanced",
            instructions: ["Start in a hand plank position and walk your hands further out until your ears are between your biceps.", "Hold in this position for the allotted amount of time.", "Make sure you keep a flat back for the whole set."]
        },
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-abdominals-stretch-variation-1-side.mp4#t=0.1",
    ...
    obliques: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-abdominals-stretch-variation-3-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-cable-woodchopper-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-Dumbbells-dumbbell-russian-twist-side.mp4#t=0.1",
            exerciseName: "Dumbbell Russian Twist",
            difficulty: "Intermediate",
            instructions: ["Sit on the floor and flex your knees and hips to a 90 degree angle.", "Your feet should be hovering off the ground. (If that's too hard start with heels on the floor)", "Rotate your upper spine to engage your obliques."]
        },
        {
    ...
    quads: [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-quads-stretch-variation-3-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-machine-leg-extension-side.mp4#t=0.1",
    ...
    calves: [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-calves-stretch-variation-1-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-tip-toe-walking-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-kettlebell-single-leg-calf-raises-front.mp4#t=0.1",
    ...
    triceps: [
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-tricep-dips-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-triceps-stretch-variation-1-front.mp4#t=0.1",
    ...
    midBack: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-bodyweight-reverse-row-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-traps-mid-back-stretch-variation-2-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-cable-silverback-shrug-front.mp4#t=0.1",
    ...
    glutes: [
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-Barbell-barbell-hip-thrust-side.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-glutes-stretch-variation-3-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/male-Cables-cable-glute-kickback-front.mp4#t=0.1",
        ...
        {
            url: "https://media.musclewiki.com/media/uploads/videos/branded/female-Dumbbells-dumbbell-bulgarian-split-squat-side.mp4#t=0.1",
